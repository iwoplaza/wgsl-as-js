...
declare const wgslTypeLiterals: readonly ["bool", "f32", "i32", "u32", "vec2f", "vec2i", "vec2u", "vec3f", "vec3i", "vec3u", "vec4f", "vec4i", "vec4u", "mat2x2f", "mat3x3f", "mat4x4f", "struct", "array", "atomic", "decorated"];
type WgslTypeLiteral = (typeof wgslTypeLiterals)[number];
type AnyWgslData = Bool | F32 | I32 | U32 | Vec2f | Vec2i | Vec2u | Vec3f | Vec3i | Vec3u | Vec4f | Vec4i | Vec4u | Mat2x2f | Mat3x3f | Mat4x4f | WgslStruct | WgslArray | Atomic | Decorated;
...
interface WgslFn<TArgs extends unknown[] = unknown[], TReturn = unknown> {
    readonly type: "fn";
    readonly label: string | undefined;
